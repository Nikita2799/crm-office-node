...
export class ClientApi {
  ...
  async postNameBase(params: Array<unknown>) {
    const sqlString =
      "CREATE TABLE `office-crm_db`.?? ( `id` INT NOT NULL AUTO_INCREMENT , `userId` INT NOT NULL , `name` VARCHAR(150) NOT NULL,`phone` VARCHAR(30) NOT NULL , `address` VARCHAR(500) NOT NULL , `status` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB";
